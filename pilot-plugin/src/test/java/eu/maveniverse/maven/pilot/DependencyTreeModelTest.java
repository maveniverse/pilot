...
import eu.maveniverse.maven.pilot.mvn3.MojoHelper;
...
class DependencyTreeModelTest {
    ...
    void fromDependencyNodeScopeFilterCompile() {
        ...
        var model = MojoHelper.fromDependencyNode(root, "compile");
    ...
    void fromDependencyNodeScopeFilterRuntime() {
        ...
        var model = MojoHelper.fromDependencyNode(root, "runtime");
    ...
    void fromDependencyNodeScopeFilterTest() {
        ...
        var model = MojoHelper.fromDependencyNode(root, "test");
    ...
    void fromDependencyNodeNoScopeFilterShowsAll() {
        ...
        var model = MojoHelper.fromDependencyNode(root, null);
    ...
    void fromDependencyNodeInvalidScopeThrows() {
        ...
        assertThatThrownBy(() -> MojoHelper.fromDependencyNode(root, "invalid"))
